...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <form method="POST" action="{{route('backend.menus.update', [ 'menu' => $menus->id ])}}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                        <div class="card-body">
                            <label class="form-label" for="basic-default-password12">Tên tiêu đề</label>
                            <div class="form-floating">
                                <input type="text" class="form-control" name="name" value="{{$menus->name}}" id="floatingInput" placeholder="VD: Trang chủ" aria-describedby="floatingInputHelp">
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input name="url" type="text" value="{{$menus->url}}" class="form-control" id="basic-icon-default-fullname" placeholder=" /home" aria-label="VanA" aria-describedby="basic-icon-default-fullname2">
                            </div>
                            @error('url')
                            <div class="alert alert-danger"> {{$message}}</div>
                            @enderror
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                <input name="sort" value="{{$menus->sort}}" type="text" class="form-control" id="basic-icon-default-fullname" placeholder=" 1" aria-label=" 1 " aria-describedby="basic-icon-default-fullname2">
                            </div>
                            @error('sort')
                            <div class="alert alert-danger"> {{$message}}</div>
                            @enderror
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-check form-switch mb-2">
                                <input class="form-check-input" name="check" type="checkbox" id="flexSwitchCheckDefault" @if($menus->status==1)checked @endif>
