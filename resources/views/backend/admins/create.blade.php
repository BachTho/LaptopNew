...
@section('title')
Tạo Admins | LaptopNew - Admin
@endsection
@section ('content')
<div class="content-wrapper">
    <!-- Content -->
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tài khoản /</span> Tạo tài khoản nhân viên</h4>
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <h5 class="card-header">Tài khoản nhân viên</h5>
                    <form method="POST" action="{{route('backend.admins.store')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
