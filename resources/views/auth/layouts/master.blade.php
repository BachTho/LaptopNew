...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" type="image/x-icon" href="/backend/assets/img/favicon/register.jpg" />
            ...
            <div class="app-brand justify-content-center">
              <a href="{{route('index')}}" class="app-brand-link gap-2">
                <span class="app-brand-text demo text-body fw-bolder">
                  <img class="rounded-circle" width="100px" src="/backend/assets/img/register.jpg" alt="">
                </span>
                <span class="app-brand-text demo text-body fw-bolder">LaptopNew</span>
              </a>
            </div>
            <!-- /Logo -->
            @yield('content')
