        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb__links">
                    ...
                    <span>Sản phẩm theo {{$categoryname->name}}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-9">
                <div class="row">
                    @foreach ($categoryname->products as $product)
                   ...
                   {{ Illuminate\Support\Facades\Storage::disk($product->images()->first()->path)->url($product->images()->first()->image)}}
                    @endif" style="background-image: url(&quot;/frontend/img/shop/shop-1.jpg&quot;);">
                                ...
                                <ul class="product__hover">
                                    <li><a href="  {{ Illuminate\Support\Facades\Storage::disk($product->images()->first()->path)->url($product->images()->first()->image)}}" class="image-popup"><span class="arrow_expand"></span></a></li>
                            ...
                            <div class="product__item__text">
                                <h6 class="cssContent"><a href="#">{{$product->name}}</a></h6>
