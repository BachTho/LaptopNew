...
<div class="container-fluid bg-secondary mb-5">
    <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
        <h1 class="font-weight-semi-bold text-uppercase mb-3">LAPTOP NEW</h1>
        <div class="d-inline-flex">
            <p class="m-0"><a href="{{route('index')}}">Home</a></p>
            <p class="m-0 px-2">-</p>
            <p class="m-0">Điều Khoản Dịch Vụ</p>
        </div>
    </div>
</div>
            ...
            <div class="main-page">
                <article id="post-2988" class="post-2988 page type-page status-publish hentry">
                    <div class="entry-content">
                        ...
                        <p>– Thông báo cho chúng tôi về việc hủy giao dịch qua đường dây nóng 0979590884</p>
